...
class TOC_Order {
	...
	protected $_valid_order = FALSE;
	protected $_contents = array();
	protected $_currency = array();
	protected $_shipping_address = array();
	protected $_billing_address = array();
	...
	protected $_is_gift_wrapping = FALSE;
	protected $_gift_wrapping_message = '';
	protected $_coupon_code = NULL;
	protected $_coupon_amount = 0;
	protected $_order_id = 0;
	protected $_customers_id = 0;
	protected $_invoice_number = NULL;
	protected $_invoice_date = NULL;
	protected $_payment_method = '';
	protected $_payment_module = '';
	protected $_deliver_method = '';
	protected $_deliver_module = '';
	protected $_gift_certificate_codes = array();
	protected $_gift_certificate_redeem_amount = array();
	protected $_content_type;
	protected $_customer_credit = 0;
	protected $_order_totals = array();
	protected $_credit_card = array();
	protected $_use_customer_credit = FALSE;
	protected $_has_payment_method = TRUE;
	protected $_last_modified;
	protected $_customers_comment;
	protected $_admin_comment;
	protected $_status_id;
	protected $_status;
	protected $_date_purchased;
	protected $_status_history = array();
	protected $_transaction_history = array();
	...
	public function _get_summary($order_id)
	{
