...
class Order_Model extends CI_Model
{
	 ...
	 * @return bool
	 */
	public function update_currency($orders_id, $currency, $currency_value)
	{
		$this->db->update('orders', array('currency' => $currency, 'currency_value' => $currency_value), array('orders_id' => $orders_id));
