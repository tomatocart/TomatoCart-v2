...
?>
Ext.define('Toc.modules_order_total.OrderTotalModuleConfigDialog', {
    extend: 'Ext.Window',
    ...
    buildForm: function(code) {
        this.moduleForm = new Ext.form.FormPanel({ 
            url: '<?php echo site_url('modules_order_total/save'); ?>',
            baseParams: {  
                code: code
            }, 
            region: 'center',
    ...
    requestForm: function(code) {
        Ext.Ajax.request({
            url: '<?php echo site_url('modules_order_total/get_configuration_options'); ?>',
            params: {
            	code: code
            },
