...
?>
Ext.define('Toc.modules_payment.PaymentModuleConfigDialog', {
    extend: 'Ext.Window',
    ...
    buildForm: function(code) {
        this.moduleForm = new Ext.form.FormPanel({ 
            url: '<?php echo site_url('modules_payment/save'); ?>',
            baseParams: {  
                code: code
            }, 
            region: 'center',
    ...
    requestForm: function(code) {
        Ext.Ajax.request({
            url: '<?php echo site_url('modules_payment/get_configuration_options'); ?>',
            params: {
            	code: code
            },
