...
Ext.define('Toc.modules_payment.ModulesPaymentGrid', {
    ...
    constructor: function(config) {
        ...
        config.store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url : '<?php echo site_url('modules_payment/list_payments'); ?>',
                reader: {
                    type: 'json',
        ...
        config.columns =[
            {header: '<?php echo lang('table_heading_payment_modules'); ?>', dataIndex: 'title', flex: 1},
    ...
    onInstall: function(grid, row, col) {
        ...
        this.el.mask();
        Ext.Ajax.request({
            url: '<?php echo site_url('modules_payment'); ?>' + '/' + action,
            params: {
            	code: rec.get('code')
            },
