<?php
/*
  $Id: modules_service_config_dialog.php $
...
?>
Ext.define('Toc.modules_service.ServicesModuleConfigDialog', {
    extend: 'Ext.Window',
    
    constructor: function(config) {
        config = config || {};
        
        config.id = 'modules_services-dialog-win';
        config.width = 400;
        config.height = 400;
        config.modal = true;
        config.iconCls = 'icon-modules_service-win';
    ...
    buildForm: function(code) {
        this.moduleForm = new Ext.form.FormPanel({ 
            url: '<?php echo site_url('modules_services/save'); ?>',
            baseParams: {  
                code: code
            }, 
            region: 'center',
    ...
    requestForm: function(code) {
        Ext.Ajax.request({
            url: '<?php echo site_url('modules_services/get_configuration_options'); ?>',
            params: {
            	code: code
            },
