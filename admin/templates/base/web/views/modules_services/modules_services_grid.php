...
Ext.define('Toc.modules_services.ModulesServicesGrid', {
    ...
    constructor: function(config) {
        ...
        config.store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url : '<?php echo site_url('modules_services/list_services'); ?>',
                reader: {
                    type: 'json',
        ...
        config.columns =[
            {header: '<?php echo lang('table_heading_services_modules'); ?>', dataIndex: 'title', flex: 1},
            {
                header: 'Actions',
                xtype: 'actioncolumn',
                items: [
    ...
    onInstall: function(grid, row, col) {
        ...
        this.el.mask();
        Ext.Ajax.request({
            url: '<?php echo site_url('modules_services'); ?>' + '/' + action,
            params: {
            	code: rec.get('code')
            },
