...
Ext.define('Toc.modules_shipping.ModulesShippingGrid', {
    ...
    constructor: function(config) {
        ...
        config.store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url : '<?php echo site_url('modules_shipping/list_shippings'); ?>',
                reader: {
                    type: 'json',
        ...
        config.columns =[
            {header: '<?php echo lang('table_heading_shipping_modules'); ?>', dataIndex: 'title', flex: 1},
    ...
    onInstall: function(grid, row, col) {
        ...
        this.el.mask();
        Ext.Ajax.request({
            url: '<?php echo site_url('modules_shipping'); ?>' + '/' + action,
            params: {
            	code: rec.get('code')
            },
