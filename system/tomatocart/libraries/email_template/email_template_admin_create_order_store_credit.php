...
/**
 * Admin Create Order Store Credit -- Email Template Module Class
 *
 * @package		TomatoCart
 ...
 */
class TOC_Email_Template_admin_create_order_store_credit extends TOC_Email_Template_Module
{
	/**
	 * Email Template Name
	 *
	...
	*/
	 ...
	 * @return void
	 */
	public function set_data($customer_name, $customer_email_address, $returned_products, $order_number, $total_amount)
	{
		$this->data = array(
...
/* End of file email_template_admin_create_order_store_credit.php */
/* Location: ./system/tomatocart/libraries/email_template/email_template_admin_create_order_store_credit.php */