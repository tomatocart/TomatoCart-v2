...
class TOC_Shipping_table extends TOC_Shipping_Module 
{
	...
	protected $code = 'table';

	protected $params = array(
		array(
			'name' => 'MODULE_SHIPPING_TABLE_STATUS',
		...
		array(
			'name' => 'MODULE_SHIPPING_TABLE_COST',
		...
		array(
			'name' => 'MODULE_SHIPPING_TABLE_TAX_CLASS',
		...
		array(
			'name' => 'MODULE_SHIPPING_TABLE_ZONE',
		...
		array(
			'name' => 'MODULE_SHIPPING_TABLE_WEIGHT_UNIT',
		...
		array(	
			'name' => 'MODULE_SHIPPING_TABLE_SORT_ORDER',
